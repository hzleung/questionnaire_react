...
class index extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch({
      type: 'grant_student_detail/fetchGrantDetail',
      payload: { hjmdid: hjmdid },
      search: search,
    });
    this.props.dispatch({
      type: 'grant_student_detail/fetchReviewInfo',
    ...
    return (
      ...
      <div style={{ background: 'rgba(242,244,247,1)', marginBottom: '90px' }}>
        ...
        <div className={styles.detialBox}>
          ...
          <div className={styles.detialLine}>
            <div className={styles.title}>助学金额：</div>
...
function mapStateToProps(state) {
  const { routing,login, grant_student_detail } = state;
  return {
      user: login.user,
      ...grant_student_detail
  };
}
