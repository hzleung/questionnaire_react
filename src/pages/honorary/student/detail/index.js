...
class index extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch({
      type: 'honorary_student_detail/fetchHonoraryDetail',
      payload: { hjmdid: hjmdid },
      search: search,
    });
    this.props.dispatch({
      type: 'honorary_student_detail/fetchReviewInfo',
    ...
    return (
      ...
      <div style={{ background: 'rgba(242,244,247,1)', marginBottom: '90px' }}>
        ...
        <div className={styles.detialBox}>
          ...
          <div className={styles.detialLine}>
            <div className={styles.title}>荣誉名称：</div>
          ...
          <div className={styles.detialLine}>
            <div className={styles.title}>评定周期：</div>
...
function mapStateToProps(state) {
  const { routing,login, honorary_student_detail } = state;
  return {
      user: login.user,
      ...honorary_student_detail
  };
}
